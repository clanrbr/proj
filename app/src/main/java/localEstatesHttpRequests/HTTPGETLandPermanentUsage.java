 ...
 */
public class HTTPGETLandPermanentUsage extends AsyncTask<String, Void, String> {
    ...
    protected void onPostExecute(String result) {
        ...
        delegate.processGetLandPermanentUsagePropertyFinish(landPermanentUsageArray);
